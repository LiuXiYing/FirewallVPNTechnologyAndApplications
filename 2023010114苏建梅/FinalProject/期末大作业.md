...
| internet | fw公网IP:8080 | 成功(DNAT到dmz) | 成功| |
...
|:-----|:---------|:-------|:---------|:-----|:-----|
| 1 | remote wg0 | 10.10.10.2:60518| 10.40.0.2:8080| TCP| 封装前 |
| 2 | fw wg0 |10.10.10.2:39086 | 10.40.0.2:8080| TCP| 解封装后 |
| 3 | fw veth-fw-dmz |10.10.10.2:60638 | 10.40.0.2:8080|TCP | 转发到dmz |
| 4 | conntrack |	10.10.10.2 | 10.40.0.2:8080| TCP| 连接跟踪记录 |
